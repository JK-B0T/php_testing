...
<body>
    <form action="{{ route('logear_usuario') }}" method="POST">
    ...
    <a href="{{route('index')}}">¿No se ha registrado aún? Haga click aquí</a>
    <br>
    <a href="{{route('enviar_mail')}}">¿Se le olvido la contraseña? Haga click aquí</a>
    <?php
